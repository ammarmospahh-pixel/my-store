...
/* ==========================================
   تنسيقات الهواتف والشاشات الصغيرة (Responsive)
   ========================================== */
@media (max-width: 768px) {
  /* 1. ضبط الهيدر وشريط التنقل */
  header {
  ...
  /* 3. ضبط كروت المنتجات لتناسب عرض شاشة الموبايل */
  .cards-container {
    gap: 15px;
    padding: 0 5px;
  }
  ...
  .card {
    width: 100%;          /* يجعل الكارت يأخذ العرض المتاح */
    max-width: 320px;      /* يمنع الكارت من أن يصبح عريضاً جداً */
    margin: 0 auto;
  }

  /* 4. إصلاح النافذة المنبثقة (Modal) بالكامل للموبايل */
  .propertes-cart-modal {
    padding: 10px !important;
  }

  .propertes-cart-content {
    width: 95% !important;
  ...
  /* جعل الصورة والتفاصيل تحت بعض داخل النافذة */
  .propertes-main-grid {
  ...
  .related-card-item {
    flex: 0 0 160px !important; /* تصغير عرض كروت المنتجات المشابهة لتناسب السكرول الأفقي */
